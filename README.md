...
```sh
go get -d github.com/lilic/instrumently
cd $GOPATH/src/github.com/lilic/instrumently
godep restore
```
...
`kubernetes/staging/src/github.com/lilic/instrumently` and its dependencies
...
https://github.com/kubernetes/kubernetes/blob/master/staging/src/github.com/lilic/instrumently.
